...
import { GOOGLE_MEET, ZOOM, SUCCESS_STATUS, OFFICE_365_VIDEO, coachos_VIDEO } from "@coachos/platform-constants";
...
export class ConferencingController {
  ...
  @ApiParam({
    name: "app",
    description: "Conferencing application type",
    enum: [GOOGLE_MEET, ZOOM, OFFICE_365_VIDEO, coachos_VIDEO],
    required: true,
  })
  async default(
    @GetUser() user: UserWithProfile,
