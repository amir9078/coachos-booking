...
export class BookingsController_2024_08_13 {
  ...
  @ApiHeader(API_KEY_OR_ACCESS_TOKEN_HEADER)
  @ApiOperation({
    summary: "Get CoachOS Meet real time transcript download links for the booking",
    description: `Fetches all the transcript download links for the booking \`:bookingUid\`

    <Note>
    Transcripts are generated when clicking "Transcribe" during a CoachOS Meet meeting. Download links are valid for 1 hour only - make a new request to generate fresh links after expiration.
  ...
  @ApiHeader(API_KEY_OR_ACCESS_TOKEN_HEADER)
  @ApiOperation({
    summary: "Get Video Meeting Sessions. Only supported for CoachOS Meet",
