...
describe("isOriginAllowed", () => {
  describe("is allowed", () => {
    it("should return true for exact match without wildcard", () => {
      const allowedOrigins = ["https://app.amir9078.github.io/callback"];
      const origin = "https://app.amir9078.github.io/callback";
    ...
    it("should handle multiple allowed URIs where only one matches", () => {
      const allowedOrigins = [
        "https://app.amir9078.github.io/other",
        "*.notthisone.com",
        "https://app.amir9078.github.io/callback",
      ];
      const origin = "https://app.amir9078.github.io/callback";
      expect(isOriginAllowed(origin, allowedOrigins)).toBe(true);
    });
  ...
  describe("is not allowed", () => {
    it("should return false if no allowed patterns match", () => {
      const allowedOrigins = ["https://app.amir9078.github.io/callback", "*.multiscreen.d1test.biz", "*/callback"];
