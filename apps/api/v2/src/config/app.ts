...
const loadConfig = (): AppConfig => {
  ...
  return {
    ...
    api: {
      ...
      keyPrefix: getEnv("API_KEY_PREFIX", "coachos_"),
      licenseKey: getEnv("COACHOS_LICENSE_KEY", ""),
      licenseKeyUrl: getEnv("GET_LICENSE_KEY_URL", "https://console.amir9078.github.io/api/license"),
    },
    db: {
    ...
    app: {
      baseUrl: getEnv("WEB_APP_URL", "https://app.amir9078.github.io"),
    },
