...
const env: Partial<Omit<Environment, "NODE_ENV">> = {
  ...
  IS_E2E: "true",
  API_KEY_PREFIX: "coachos_test_",
  GET_LICENSE_KEY_URL: " https://console.amir9078.github.io/api/license",
  COACHOS_LICENSE_KEY: "c4234812-12ab-42s6-a1e3-55bedd4a5bb7",
...
process.env = {
  ...
  COACHOS_ENCRYPTION_KEY: "22gfxhWUlcKliUeXcu8xNah2+HP/29ZX",
  COACHOS_SERVICE_ACCOUNT_ENCRYPTION_KEY: "ae1ca912d1ff09f1527dae78e84f88b4",
