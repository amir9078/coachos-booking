...
// We load different translations based on the browser locale or CoachOS Booking User settings
...
test.describe("Locale-specific pages must not 404", () => {
  for (const locale of ["en", "fr"]) {
    test.describe(`/${locale}/* pages`, () => {
      ...
      // Teams, routing forms, and insights pages are removed in CoachOS Booking
    });
  }
});
