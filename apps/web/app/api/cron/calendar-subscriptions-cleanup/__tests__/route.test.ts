...
vi.mock("@coachos/features/calendar-subscription/lib/cache/CalendarCacheEventService");
vi.mock("@coachos/features/calendar-subscription/lib/cache/CalendarCacheEventRepository");
...
vi.mock("@coachos/lib/server/perfObserver", () => ({
  performance: {
    mark: vi.fn(),
    measure: vi.fn(),
  },
...
vi.mock("@coachos/lib/server/getServerErrorFromUnknown", () => ({
