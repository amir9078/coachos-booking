...
import { getOGImageVersion } from "@coachos/lib/OgImages";
...
vi.mock("@coachos/lib/OgImages", async (importOriginal) => {
  return await importOriginal();
});

vi.mock(import("@coachos/lib/constants"), async (importOriginal) => {
  return await importOriginal();
});

vi.mock("@coachos/web/public/app-store/svg-hashes.json", () => ({
  default: {
