...
- Different CoachOS Booking circumstances
    ...
    - Embeds
        - There could be many embeds on the same origin(https://acme.amir9078.github.io) using different themes. e.g. for demo page someone wants to force light theme(as that page doesn't have dark mode) and for landing page someone wants to adapt to system theme as that page supports both modes.
