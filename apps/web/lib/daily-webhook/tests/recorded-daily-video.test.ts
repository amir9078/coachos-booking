...
import { getBatchProcessorJobAccessLink, getRoomNameFromRecordingId } from "@coachos/app-store/dailyvideo/lib";
...
import * as recordedDailyVideoRoute from "@coachos/web/app/api/recorded-daily-video/route";
...
vi.mock("@coachos/app-store/dailyvideo/lib", () => {
  return {
