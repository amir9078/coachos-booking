...
function getCspPolicy(nonce: string) {
  ...
  // We add WEBAPP_URL to img-src because of booking pages, which end up loading images from app.amir9078.github.io on amir9078.github.io
  ...
  return `
    ...
    object-src 'none';
    base-uri 'none';
	  child-src app.amir9078.github.io;
	  style-src 'self' ${
