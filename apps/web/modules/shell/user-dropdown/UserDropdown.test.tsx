...
vi.mock("@coachos/lib/hooks/useUserAgentData", () => ({
  useUserAgentData: () => ({
    os: "linux",
    browser: "chrome",
    isMobile: false,
...
vi.mock("@coachos/trpc/react/hooks/useMeQuery", () => ({
  default: () => mockUseMeQuery(),
}));

vi.mock("@coachos/web/modules/api-keys/support/lib/freshchat/FreshChatProvider", () => ({
