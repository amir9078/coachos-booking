...
type CoachosMeetCallbacksParams = {
...
export const createCoachosMeetCallbacks = (params: CoachosMeetCallbacksParams) => {
  const {
    daily,
    recording,
    transcription,
...
export const CoachosMeetPremiumFeatures = ({
  showRecordingButton,
  enableAutomaticTranscription,
  enableAutomaticRecordingForOrganizer,
  showTranscriptionButton,
  ...
  const callbacks = createCoachosMeetCallbacks({
    daily,
    recording,
    transcription,
    showRecordingButton,
