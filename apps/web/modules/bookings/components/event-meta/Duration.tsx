...
import { useShouldShowArrows } from "@coachos/web/modules/apps/components/AllApps";
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      ...
      if (selectedDuration && itemRefs.current[selectedDuration]) {
        // eslint-disable-next-line @coachos/eslint/no-scroll-into-view-embed -- Called on !isEmbed case
