...
import { useIsPlatformBookerEmbed } from "@coachos/atoms/hooks/useIsPlatformBookerEmbed";
import dayjs from "@coachos/dayjs";
import { useEmbedUiConfig } from "@coachos/embed-core/embed-iframe";
import { updateEmbedBookerState } from "@coachos/embed-core/src/embed-iframe";
...
} from "@coachos/features/bookings/Booker/config";
import framerFeatures from "@coachos/features/bookings/Booker/framer-features";
import type { BookerProps } from "@coachos/features/bookings/Booker/types";
import { isBookingDryRun } from "@coachos/features/bookings/Booker/utils/isBookingDryRun";
import { isTimeSlotAvailable } from "@coachos/features/bookings/Booker/utils/isTimeslotAvailable";
import { getQueryParam } from "@coachos/features/bookings/Booker/utils/query-param";
import { Header } from "@coachos/features/bookings/components/Header";
import { BookerSection } from "@coachos/features/bookings/components/Section";
import { Dialog } from "@coachos/features/components/controlled-dialog";
import { scrollIntoViewSmooth } from "@coachos/lib/browser/browser.utils";
import {
  CLOUDFLARE_SITE_ID,
...
import TurnstileCaptcha from "@coachos/web/modules/auth/components/Turnstile";
import { useSkipConfirmStep } from "@coachos/web/modules/bookings/hooks/useSkipConfirmStep";
...
const BookerComponent = ({
  ...
  const scrollToTimeSlots = () => {
    ...
    if (
      ...
      // eslint-disable-next-line @coachos/eslint/no-scroll-into-view-embed -- We are allowing it here because scrollToTimeSlots is called on explicit user action where it makes sense to scroll, remember that the goal is to not do auto-scroll on embed load because that ends up scrolling the embedding webpage too
