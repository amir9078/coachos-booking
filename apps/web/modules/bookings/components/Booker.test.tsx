import "@coachos/features/bookings/Booker/__mocks__/config";
...
import "@coachos/lib/__mocks__/logger";
...
import "@coachos/dayjs/__mocks__";
import "@coachos/web/modules/auth/components/Turnstile";

import { render, screen } from "@coachos/features/bookings/Booker/__tests__/test-utils";
...
vi.mock("@coachos/features/calendars/components/NoAvailabilityDialog", () => ({
  default: () => {
    return null;
  },
}));
...
vi.mock("@coachos/atoms/hooks/useIsPlatformBookerEmbed", () => ({
