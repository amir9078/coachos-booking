...
import { throwIfNotHaveAdminAccessToTeam } from "@coachos/app-store/_utils/throwIfNotHaveAdminAccessToTeam";
import { getServerSession } from "@coachos/features/auth/lib/getServerSession";
import { deriveAppDictKeyFromType } from "@coachos/lib/deriveAppDictKeyFromType";
...
import type { AppDeclarativeHandler, AppHandler } from "@coachos/types/AppHandler";
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    const handlerMap = (await import("@coachos/app-store/apps.server.generated")).apiHandlers;
