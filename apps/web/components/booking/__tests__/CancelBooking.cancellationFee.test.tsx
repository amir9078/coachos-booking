...
import * as shouldChargeModule from "@coachos/features/bookings/lib/payment/shouldChargeNoShowCancellationFee";
...
afterAll(() => {
  ...
  vi.unmock("@coachos/embed-core/embed-iframe");
});
...
vi.mock("@coachos/lib/hooks/useRefreshData", () => ({
...
vi.mock("@coachos/features/bookings/lib/payment/shouldChargeNoShowCancellationFee", () => ({
