...
```
<CoachOS Booking URL>/api/integrations/zoomvideo/callback
```
...
13. **Complete Zoom Integration** - Your Zoom integration is now ready and can be easily added in the CoachOS Booking settings.
