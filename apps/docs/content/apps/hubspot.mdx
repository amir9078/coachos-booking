...
```
<CoachOS Booking URL>/api/integrations/hubspot/callback
```

Replace `<CoachOS Booking URL>` with the URL where your application is hosted.
...
10. **Complete HubSpot Integration** - You're all set! Any booking in CoachOS Booking will now be created as a meeting in HubSpot for your contacts.
