...
The team at Northflank also have a [detailed blog post](https://northflank.com/guides/deploy-coachos-with-northflank) on deploying Cal.diy on their platform.
