...
[![Run on Google Cloud](https://storage.googleapis.com/gweb-cloudblog-publish/images/run_on_google_cloud.max-300x300.png)](https://deploy.cloud.run/?git_repo=https://github.com/amir9078/coachos-booking)
...
```bash
docker run -d -p 80:80 calcom/cal.com
```
