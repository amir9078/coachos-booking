...
```bash
git clone https://github.com/calcom/CoachOS Booking.git
```

> If you are on windows, you would need to use the following command when cloning, with **admin privileges**:
>
> ```bash
> git clone -c core.symlinks=true https://github.com/calcom/CoachOS Booking.git
> ```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/calcom/CoachOS Booking)
