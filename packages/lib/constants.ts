...
export const COACHOS_ENV = process.env.COACHOS_ENV || process.env.NODE_ENV;
export const IS_PRODUCTION = COACHOS_ENV === "production";
...
export const LOGO = "/coachos-logo-white-word.svg";
export const LOGO_DARK = "/coachos-logo-word-black.svg";
export const LOGO_ICON = "/coachos-icon-white.svg";
...
export const JOIN_COMMUNITY = "https://github.com/calcom/CoachOS Booking/discussions";
...
export const COACHOS_VERSION = process.env.NEXT_PUBLIC_COACHOS_VERSION as string;

export const APP_CREDENTIAL_SHARING_ENABLED =
  !!process.env.COACHOS_CREDENTIAL_SYNC_SECRET && !!process.env.COACHOS_APP_CREDENTIAL_ENCRYPTION_KEY;
export const CREDENTIAL_SYNC_SECRET = process.env.COACHOS_CREDENTIAL_SYNC_SECRET;
export const CREDENTIAL_SYNC_SECRET_HEADER_NAME =
  process.env.COACHOS_CREDENTIAL_SYNC_HEADER_NAME || "coachos-credential-sync-secret";

export const CREDENTIAL_SYNC_ENDPOINT = process.env.COACHOS_CREDENTIAL_SYNC_ENDPOINT;

// Service Account Encryption Key for encrypting/decrypting service account keys
export const SERVICE_ACCOUNT_ENCRYPTION_KEY = process.env.COACHOS_SERVICE_ACCOUNT_ENCRYPTION_KEY;
