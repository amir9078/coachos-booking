...
describe("isSafeUrlToLoadResourceFrom", () => {
  ...
  it("should return true for URLs with same TLD+1 as WEBAPP_URL", () => {
    expect(isSafeUrlToLoadResourceFrom("https://acme.amir9078.github.io/path")).toBe(true);
    expect(isSafeUrlToLoadResourceFrom("http://dunder.amir9078.github.io?query=1")).toBe(true);
    expect(isSafeUrlToLoadResourceFrom("https://amir9078.github.io/path")).toBe(true);
  });
