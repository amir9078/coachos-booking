...
- Identify all `@coachos/ui` usages in the scope of the migration.
...
For example, `DateRangePicker` from `@coachos/ui/components/form` is lazy-loaded:
...
// Use:
import { DatePickerWithRange as DateRangePicker } from "@coachos/ui/components/form/date-range-picker/DateRangePicker";
```
