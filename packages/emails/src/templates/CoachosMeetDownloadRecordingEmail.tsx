...
interface CoachosMeetDownloadRecordingEmailProps {
  language: TFunction;
  downloadLink: string;
  title: string;
  date: string;
...
export const CoachosMeetDownloadRecordingEmail = (
  props: CoachosMeetDownloadRecordingEmailProps & Partial<React.ComponentProps<typeof V2BaseEmailHtml>>
) => {
  ...
  return (
    <V2BaseEmailHtml
      ...
      <p style={{ fontWeight: 500, lineHeight: "20px", marginTop: "8px" }}>
        ...
        <a href="https://amir9078.github.io/docs/enterprise-features/teams/coachos-meet-recordings">
          {props.language("here")}
        </a>
      </p>
