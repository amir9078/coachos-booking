...
interface CoachosMeetDownloadTranscriptEmailProps {
  language: TFunction;
...
export const CoachosMeetDownloadTranscriptEmail = (
  props: CoachosMeetDownloadTranscriptEmailProps & Partial<React.ComponentProps<typeof V2BaseEmailHtml>>
) => {
