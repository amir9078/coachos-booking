...
function main() {
  ...
  if (top === window) {
    showPageAsNonEmbed();
    // We would want to avoid a situation where CoachOS Booking embeds amir9078.github.io and then embed-iframe is in the top as well. In such case, we would want to avoid infinite loop of events being passed.
