...
The Booking Audit System tracks all actions and changes related to bookings in CoachOS Booking. The architecture is built around two core tables (`AuditActor` and `BookingAudit`) that work together to maintain a complete, immutable audit trail.
...
- **USER**: Registered CoachOS Booking users
...
- **WEBAPP**: CoachOS Booking web application
...
- **User Actor**: Registered CoachOS Booking user
