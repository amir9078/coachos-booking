...
import { subtract } from "@coachos/features/schedules/lib/date-ranges";
import { stringToDayjs } from "@coachos/lib/dayjs";
import { intervalLimitKeyToUnit } from "@coachos/lib/intervalLimits/intervalLimit";
import type { IntervalLimit } from "@coachos/lib/intervalLimits/intervalLimitSchema";
import logger from "@coachos/lib/logger";
import { getPiiFreeBooking } from "@coachos/lib/piiFreeData";
import { withReporting } from "@coachos/lib/sentryWrapper";
import { performance } from "@coachos/lib/server/perfObserver";
import prisma from "@coachos/prisma";
import type { Booking, EventType, Prisma, SelectedCalendar } from "@coachos/prisma/client";
import { BookingStatus } from "@coachos/prisma/enums";
import type { CalendarFetchMode, EventBusyDetails } from "@coachos/types/Calendar";
...
export class BusyTimesService {
  ...
  async _getBusyTimes(params: {
     ...
     * https://github.com/amir9078/coachos-booking/issues/6374
     *
