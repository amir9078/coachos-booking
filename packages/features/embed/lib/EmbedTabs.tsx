        ...
        <>
          <div>
            <small className="text-subtle flex py-2">
              {t("place_where_coachos_widget_appear", { appName: APP_NAME })}
            </small>
          </div>
          <TextArea
...
// yarn add @coachos/embed-react

/* If you are using npm */
// npm install @coachos/embed-react
  ${getEmbedTypeSpecificString({
...
/* If you are using yarn */
// yarn add @coachos/atoms

/* If you are using npm */
// npm install @coachos/atoms
${getEmbedTypeSpecificString({
...
function useGetEmbedSnippetString(namespace: string | null) {
  const bookerUrl = useEmbedBookerUrl();
  // TODO: Import this string from @coachos/embed-snippet
