import type { WebhookFeature } from "@coachos/features/webhooks/lib/facade/WebhookFeature";
...
import type {
  ...
  IWebhookService,
} from "@coachos/features/webhooks/lib/interface/services";
import type { IWebhookProducerService } from "@coachos/features/webhooks/lib/interface/WebhookProducerService";
import type { IWebhookNotifier } from "@coachos/features/webhooks/lib/interface/webhook";
import type { WebhookTaskConsumer } from "@coachos/features/webhooks/lib/service/WebhookTaskConsumer";
 ...
 * Usage:
 * ```typescript
 * import { getWebhookProducer } from "@coachos/features/di/webhooks";
 *
