...
vi.mock("@coachos/features/bookings/repositories/AttendeeRepository", () => ({
...
vi.mock("@coachos/features/bookings/services/BookingAccessService", () => ({
...
vi.mock("@coachos/features/webhooks/lib/WebhookService", () => ({
  WebhookService: {
...
vi.mock("@coachos/lib/getOrgIdFromMemberOrTeamId", () => ({
