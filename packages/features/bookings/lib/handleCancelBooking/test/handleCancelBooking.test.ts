...
vi.mock("@coachos/features/bookings/lib/payment/processPaymentRefund", () => ({
...
describe("Cancel Booking", () => {
  ...
  test("Should trigger BOOKING_CANCELLED webhook", async ({ emails }) => {
    const handleCancelBooking = (await import("@coachos/features/bookings/lib/handleCancelBooking")).default;
