...
vi.mock("@coachos/features/bookings/lib/EventManager", () => ({
...
vi.mock("@coachos/emails/templates/attendee-cancelled-email", () => ({
...
vi.mock("@coachos/trpc/server/routers/viewer/bookings/addGuests.handler", async (importOriginal) => {
