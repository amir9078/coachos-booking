...
import type { RegularBookingCreateResult } from "@coachos/features/bookings/lib/dto/types";
import type { Slots } from "@coachos/features/calendars/lib/types";
import type { PublicEventType } from "@coachos/features/eventtypes/lib/getPublicEvent";
...
export type MarkNoShowResponse = Awaited<
  ReturnType<typeof import("@coachos/features/handleMarkNoShow").default>
>;
