import { mockCrmApp } from "@coachos/testing/lib/bookingScenario/bookingScenario";

import type { TFunction } from "i18next";
import { describe, expect, test, vi, afterEach } from "vitest";

vi.mock("@coachos/app-store/salesforce/lib/graphql/SalesforceGraphQLClient", () => ({
  SalesforceGraphQLClient: vi.fn(),
}));
vi.mock("@coachos/app-store/salesforce/lib/CrmService", () => ({
  default: vi.fn(),
}));
vi.mock("@urql/core", () => ({
  Client: vi.fn(),
...
// vi.mock("@coachos/app-store/_utils/getCrm");
