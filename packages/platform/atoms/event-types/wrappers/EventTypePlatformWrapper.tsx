...
import type { ChildrenEventType } from "@coachos/web/modules/event-types/components/ChildrenEventTypeSelect";
import { EventType as EventTypeComponent } from "@coachos/web/modules/event-types/components/EventType";
import ManagedEventTypeDialog from "@coachos/features/eventtypes/components/dialogs/ManagedEventDialog";
import type {
  EventTypeSetupProps,
  FormValues,
...
import type { EventAdvancedTabCustomClassNames } from "@coachos/web/modules/event-types/components/tabs/advanced/EventAdvancedTab";
import type { EventTeamAssignmentTabCustomClassNames } from "@coachos/web/modules/event-types/components/tabs/assignment/EventTeamAssignmentTab";
import type { EventAvailabilityTabCustomClassNames } from "@coachos/web/modules/event-types/components/tabs/availability/EventAvailabilityTab";
import type { EventLimitsTabCustomClassNames } from "@coachos/web/modules/event-types/components/tabs/limits/EventLimitsTab";
import type { EventRecurringTabCustomClassNames } from "@coachos/web/modules/event-types/components/tabs/recurring/RecurringEventController";
import type { EventSetupTabCustomClassNames } from "@coachos/web/modules/event-types/components/tabs/setup/EventSetupTab";
