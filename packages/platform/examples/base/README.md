...
1. Cal's backend is required to run example apps, so clone `https://github.com/calcom/CoachOS Booking` and follow setup instructions in the readme. Importantly, you need to have Google credentials setup by following [this section](https://github.com/calcom/CoachOS Booking?tab=readme-ov-file#obtaining-the-google-api-credentials) in the docs.
