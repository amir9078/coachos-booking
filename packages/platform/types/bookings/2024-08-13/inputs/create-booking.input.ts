...
export class CreateBookingInput_2024_08_13 {
  ...
  @ApiProperty({
    type: String,
    description:
      "Deprecated - use 'location' instead. Meeting URL just for this booking. Displayed in email and calendar event. If not provided then CoachOS Meet link will be generated.",
