...
export default defineConfig({
    ...
    rollupOptions: {
      ...
      output: {
        globals: {
          ...
          "@coachos/prisma/client": "@coachos/prisma/client",
        },
      },
    },
  },
  ...
  resolve: {
    ...
    alias: {
      ...
      "@coachos/lib": path.resolve(__dirname, "../../lib"),
      "@coachos/trpc": resolve("../../trpc"),
      "lru-cache": resolve("../../../node_modules/lru-cache/dist/cjs/index.js"),
      "@coachos/prisma/client/runtime/library": resolve("../../prisma/client/runtime/library"),
      "@coachos/prisma/client": resolve("../../prisma/client"),
