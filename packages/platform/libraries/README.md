...
https://www.npmjs.com/package/@coachos/platform-libraries?activeTab=code
...
- run `yarn publish-npm` - it will check "@coachos/platform-libraries" version in npm and update it's package.json to the next version and then it will publish the package to npm, update the version of "@coachos/platform-libraries" in the api v2 package.json, reset "@coachos/platform-libraries" to 0.0.0 and run yarn install.
