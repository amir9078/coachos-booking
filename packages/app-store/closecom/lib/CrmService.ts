...
import type { CloseComFieldOptions } from "@coachos/lib/CloseCom";
import CloseCom from "@coachos/lib/CloseCom";
import { getCustomActivityTypeInstanceData } from "@coachos/lib/CloseComeUtils";
...
import type { CRM, ContactCreateInput, CrmEvent, Contact } from "@coachos/types/CrmService";
 ...
 * to assign every contact created by this process, and it is named "From CoachOS Booking"
 */
