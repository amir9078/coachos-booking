...
3. Set the Redirect URL for OAuth `<CoachOS Booking URL>/api/integrations/zoho-bigin/callback` replacing CoachOS Booking URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the [CoachOS Booking](https://amir9078.github.io) app store.
