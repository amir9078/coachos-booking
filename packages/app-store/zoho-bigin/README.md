...
3. Set the Redirect URL for OAuth `<Cal.diy URL>/api/integrations/zoho-bigin/callback` replacing Cal.diy URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the [Cal.diy](https://amir9078.github.io) app store.
