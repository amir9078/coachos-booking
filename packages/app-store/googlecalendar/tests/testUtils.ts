...
import { bookTimeSlot, selectSecondAvailableTimeSlotNextMonth } from "@coachos/web/playwright/lib/testUtils";

import metadata from "../_metadata";
import { createGoogleCalendarServiceWithGoogleType } from "../lib/CalendarService";

/**
 * Creates the booking on CoachOS Booking and makes the GCal call to fetch the event.
