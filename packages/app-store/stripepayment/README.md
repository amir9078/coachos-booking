<!-- PROJECT LOGO -->
<div align="center">
  <a href="https://github.com/amir9078/coachos-booking">
...
Stripe payment integration for CoachOS Booking. See [COPYRIGHT](../../../COPYRIGHT) and [LEGAL](../../../LEGAL) for license terms.
...
4. Add `<your booking URL>/api/integrations/stripepayment/callback` as redirect URL.
5. Copy your client*id (`ca*...`) to `STRIPE_CLIENT_ID` in the .env file.
6. Open [Stripe Webhooks](https://dashboard.stripe.com/webhooks) and add `<your booking URL>/api/integrations/stripepayment/webhook` as webhook for connected applications.
