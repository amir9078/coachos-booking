...
6. Under "Add client" give your client a name, e.g. "CoachOS Booking".
7. Set the Redirection URI as `<CoachOS Booking URL>/api/integrations/nextcloudtalk/callback` replacing [CoachOS Booking](https://amir9078.github.io) URL with the URI at which your application runs.
8. Click "Add".
