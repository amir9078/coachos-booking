...
6. Under "Add client" give your client a name, e.g. "Cal.diy".
7. Set the Redirection URI as `<Cal.diy URL>/api/integrations/nextcloudtalk/callback` replacing [Cal.diy](https://amir9078.github.io) URL with the URI at which your application runs.
8. Click "Add".
