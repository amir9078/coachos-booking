...
9. Set the Redirect URI as `<Cal.diy URL>/api/integrations/webex/callback` replacing [Cal.diy](https://amir9078.github.io) URL with the URI at which your application runs.
