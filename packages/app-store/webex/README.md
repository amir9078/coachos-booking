...
9. Set the Redirect URI as `<CoachOS Booking URL>/api/integrations/webex/callback` replacing [CoachOS Booking](https://amir9078.github.io) URL with the URI at which your application runs.
