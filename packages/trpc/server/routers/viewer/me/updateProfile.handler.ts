...
import { sendChangeOfEmailVerification } from "@coachos/features/auth/lib/verifyEmail";
...
import { uploadAvatar } from "@coachos/lib/server/avatar";
import { getTranslation } from "@coachos/i18n/server";
import { resizeBase64Image } from "@coachos/lib/server/resizeBase64Image";
