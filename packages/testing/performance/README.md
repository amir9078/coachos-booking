# CoachOS Booking Booking Flow Performance Test Suite

This directory contains performance tests for CoachOS Booking's booking flow using [Grafana k6](https://k6.io/). The tests are designed to measure the performance of the booking flow under various load conditions, including high-volume scenarios with tens of thousands of requests per minute.

## Prerequisites

- [k6](https://k6.io/docs/getting-started/installation/) installed on your machine
- CoachOS Booking running locally or a deployed instance to test against
...
- CoachOS Booking running locally (default: `http://localhost:3000`)
...
The test suite focuses specifically on the booking flow, which is the most critical user journey in CoachOS Booking:
