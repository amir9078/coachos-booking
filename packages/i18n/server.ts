...
const { i18n } = require("@coachos/i18n/next-i18next.config");

const englishTranslations: Record<string, string> = require("@coachos/i18n/locales/en/common.json");
 ...
 * Uses @coachos/config package alias for reliable access across all packages in the monorepo
