...
Detailed documentation for authentication methods in the CoachOS Booking API v2.

## Authentication Methods

CoachOS Booking API v2 supports two authentication methods:
...
1. Log in to your CoachOS Booking account
...
All CoachOS Booking API keys are prefixed with `coachos_`:
...
5. **Monitor API usage**: Check your CoachOS Booking dashboard for unusual activity
