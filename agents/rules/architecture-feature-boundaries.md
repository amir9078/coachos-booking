...
Features communicate through well-defined interfaces. If bookings needs availability data, it imports from `@coachos/features/availability` through exported interfaces, not by reaching into internal implementation details.

**Incorrect (reaching into internals):**

```typescript
// Bad - Importing internal implementation details
import { calculateSlots } from "@coachos/features/availability/services/internal/slotCalculator";
import { AvailabilityCache } from "@coachos/features/availability/lib/cache";
```
...
import { getAvailability } from "@coachos/features/availability";
import type { AvailabilityResult } from "@coachos/features/availability";
```
