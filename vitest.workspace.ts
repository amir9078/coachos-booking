    ...
    : // It doesn't seem to be possible to fake timezone per test, so we rerun the entire suite with different TZ. See https://github.com/vitest-dev/vitest/issues/1575#issuecomment-1439286286
      ...
      : [
          ...
          },
          {
            test: {
              globals: true,
              name: "@coachos/app-store-delegation-credential",
          ...
          },
          {
            test: {
              globals: true,
              name: "@coachos/features/form-builder",
          ...
          },
          {
            test: {
              globals: true,
              name: "@coachos/features/bookings",
          ...
          {
            test: {
              name: "@coachos/packages/lib/hooks",
          ...
          },
          {
            test: {
              globals: true,
              environment: "jsdom",
              name: "@coachos/web/modules/views",
